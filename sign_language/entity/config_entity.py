...
from sign_language.constant.training_pipeline import ARTIFACTS_DIR,DATA_INGETION_DIR_NAME,DATA_INGETION_FEATURE_STORE_DIR,DATA_DOWNLOAD_URL
...
class DataIngestionConfig:
    ...
    feature_store_file_path: str = os.path.join(
        data_ingestion_dir, DATA_INGETION_FEATURE_STORE_DIR
    )
